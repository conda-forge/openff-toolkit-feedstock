...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/openff-toolkit-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/openff-toolkit-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add openff-toolkit openff-toolkit-base openff-toolkit-examples
# for installing globally
pixi global install openff-toolkit openff-toolkit-base openff-toolkit-examples
```
...
It is possible to list all of the versions of `openff-toolkit` available on your platform:
...
```
pixi search openff-toolkit --channel conda-forge
```
